...
export async function inviteUser(_prevState: ActionState, formData: FormData): Promise<ActionState> {
  ...
  // senha" (login/actions.ts). Falha aqui não desfaz o cadastro — o admin
  // pode convidar de novo depois. createResetEmailClient(), não o client de
  // sessão do admin_geral logado — ver lib/supabase/reset-email-client.ts.
